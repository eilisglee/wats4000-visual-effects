<template>
  <div>
    <div class="messages">
      <!-- Add message-container and supply messages property. -->
    ...
    <div class="word-list-container">
      <h2>Word List</h2>
      <ul class="word-list">
        <!-- Add transition-group around the list item here to animate items in the word list. -->
    ...
    <div class="results-container">
      <!-- Add spinner here to show when search is in progress. -->
      <spinner v-if="showSpinner"></spinner>
      <h2 v-if="results && results.length > 0">{{ results.length }} Words Found</h2>
      <ul v-if="results && results.length > 0" class="results">
        <!-- Add transition-group around the list item here to animate items in the results list. -->
      ...
      <!-- Add message to display here if no results are found. -->
...
// Import CubeSpinner for use as a child component
import CubeSpinner from "@/components/CubeSpinner";
// Import MessageContainer for use as a child component
  ...
  methods: {
    addWord: function(word) {
      if (this.wordList.indexOf(word) === -1) {
        ...
        // Add message to this.messages to reflect this change.
        this.messages.push({
          type: "success",
    ...
    removeWord: function(word) {
      ...
      this.messages.push({
        type: "success",
        text: `${word} remove from WordList.`
      });
    },
    findWords: function() {
